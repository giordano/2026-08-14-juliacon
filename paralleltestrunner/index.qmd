...
function run_demo(args...)
    ...
    dir = joinpath(dirname(project), "paralleltestrunner", "demo", "test")
...
* Battle-tested: [used](https://github.com/search?q=%2Fusing.*+ParallelTestRunner%2F+language%3AJulia++NOT+is%3Aarchived+NOT+is%3Afork+path%3A%2F%5Etest%5C%2Fruntests.jl%2F&type=code) by over 80 packages (2 stdlibs)
* Give it a try:
