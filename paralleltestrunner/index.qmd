...
function run_demo(args...)
    ...
    str = readchomp(ignorestatus(setenv(cmd; dir)))
    # `:light_black` is a bit unreadable with this theme, change it to `:grey`.
    str = replace(str, "\e[90m" => "\e[39m")
    print(str)
end
nothing
```
...
* Future:
  * Automatic retries of flaky tests (PR [#148](https://github.com/JuliaTesting/ParallelTestRunner.jl/pull/148)/[#157](https://github.com/JuliaTesting/ParallelTestRunner.jl/pull/157))
* Give it a try:
